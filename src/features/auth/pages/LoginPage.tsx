...
export function LoginPage() {
  ...
  return (
    <div className="relative min-h-screen overflow-hidden bg-slate-50 text-slate-900 dark:bg-slate-950 dark:text-white">
      ...
      <motion.div
        className="pointer-events-none absolute left-1/2 top-1/2 h-[520px] w-[520px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-gradient-to-r from-emerald-500/15 via-transparent to-sky-500/15 blur-3xl"
              ...
              <div className="p-6 sm:p-8">
                <div className="mb-6">
                  <div className="flex items-start justify-between gap-3">
                    <div className="flex items-center gap-3">
                      <div className="grid h-11 w-11 place-items-center rounded-2xl border border-emerald-400/25 bg-emerald-500/10 text-emerald-700 dark:text-emerald-100">
                        <Leaf className="h-5 w-5" />
                      </div>
                      <div>
                        <div className="text-sm font-semibold text-slate-900 dark:text-white">Residuos Biomédicos</div>
                        <div className="mt-0.5 text-xs text-slate-700 dark:text-white/60">Plataforma de control y trazabilidad</div>
                      </div>
                    </div>
                    <div className="hidden sm:flex items-center gap-2 rounded-xl border border-slate-200/70 bg-slate-900/5 px-3 py-2 text-xs text-slate-700 dark:border-white/10 dark:bg-white/5 dark:text-white/70">
                      <ShieldCheck className="h-4 w-4" />
                      Acceso seguro
                    </div>
                  </div>

                  <h1 className="mt-5 text-2xl font-semibold tracking-tight">Iniciar sesión</h1>
                ...
                <div className="space-y-4">
                  ...
                  <div className="grid gap-2 sm:grid-cols-3">
                    ...
                    <TrustPill label="Alertas" icon={<Workflow className="h-4 w-4" />} />
                    <TrustPill label="Reportes" icon={<Factory className="h-4 w-4" />} />
                  </div>
                </div>
              </div>
...
function TrustPill({ label, icon }: { label: string; icon: React.ReactNode }) {
  return (
    <div className="flex items-center justify-center gap-2 rounded-xl border border-slate-200/70 bg-slate-900/5 px-3 py-2 text-xs text-slate-700 dark:border-white/10 dark:bg-white/5 dark:text-white/70">
      {icon}
      {label}
    </div>
  );
